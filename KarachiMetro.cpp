...
class login
{
    ...
    public:
        ...
        void BookTickets()
        {
            ...
            PrintALLRoutes();
            cout<<"\nFrom which Stop you want to pick the Metro Bus: ";
            fflush(stdin);
            getline(cin, str1);
            cout<<"\nAt which Stop you want to leave: ";
            fflush(stdin);
            getline(cin, str2);
            fstream ob;
            ob.open("Routes.txt",ios::in);
            while(!ob.eof())  // looping for checking routes
            {
                ss++;
                j=0;
                count=0;
                ...
                int size = str3.size();
                int size2 = str4.size();
                for (int i = 0; i < size; i++) // loop for route string
                {
                    if(str3[i]=='-')
                    {
                        str6[j] = str5;
                ...
                j=0;
                k=0;
                for (int i = 0; i < size2; i++) //loop for breaking time in to strings
                {
                    if(str4[i]=='-')
                    {
                        time3[j] = time1;
                ...
                for (int i = 0; i < count-1; i++) // loop for organising route ( checking stops ) 
                {
                    if(str1==str6[i])
                    {
                        index = i;
            ...
            if(flag==1) 	// updating records and seats
            {
                fstream os,ox;
                string seats;
                ...
                if(tickets<=Se)
                {
                    ...
                    os2.open("SeatsDuplicate.txt",ios::out); //updating seats, adding revenue
